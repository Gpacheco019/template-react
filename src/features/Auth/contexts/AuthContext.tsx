...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  useLayoutEffect(() => {
    const interceptorId = httpClient
      .getAxiosInstance()
      .interceptors.request.use(async config => {
        const accessToken = await secureStorage.getEncryptedItem<string>(
    ...
    const interceptorId = httpClient
      ...
      .interceptors.response.use(
        ...
        async error => {
          ...
          const refreshToken = await secureStorage.getEncryptedItem<string>(
          ...
          await secureStorage.setEncryptedItem(
            storageKeys.accessToken,
            accessToken
          );
          await secureStorage.setEncryptedItem(
